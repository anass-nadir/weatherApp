<template>
  <div
    ...
    :class="[{ 'add__card-dark': darkMode }, 'add__card']"
  >
    ...
    <div class="body__container">
      <svg
        ...
        v-if="!darkMode"
        data-name="Plus Icon"
        viewBox="1454.4 326.4 209.1 209.1"
      >
        <defs>
          <filter
            id="Ellipse_7"
      ...
      <svg class="add__icon" viewBox="0 0 209.1 209.1" v-if="darkMode">
        <defs>
          <filter
            id="a"
            width="209.1"
      ...
      <svg
        v-if="!darkMode"
        class="city__illustration"
        id="City_Illustration0"
        data-name="City Illustration"
        viewBox="1367.8 616.6 403.6 331.4"
      >
        <path
          id="City_grass"
          d="M1488.3 646.3v-30H1892v30z"
          class="cls-1"
          data-name="City grass"
        ...
        <g id="Buidings">
          <g id="Buiding_Shadow" data-name="Buiding Shadow">
            <path
              id="Path_23"
              d="M1488.3 777.8V616.3h26.6v161.5z"
              class="cls-2"
              data-name="Path 23"
            ...
            <path
              id="Path_29"
              d="M1488.3 788.9V616.3h26.6V789z"
              class="cls-2"
              data-name="Path 29"
            ...
            <path
              id="Path_21"
              d="M1488.3 783.8V616.3h96.8v167.5z"
              class="cls-2"
              data-name="Path 21"
          ...
          <g id="Core">
            <path
              id="Path_8"
              d="M1488.3 771.2V616.3h59.7v154.9z"
              class="cls-3"
              data-name="Path 8"
            ...
            <path
              id="Path_10"
              fill="#7affcb"
              d="M1488.3 660.7v-44.4h96.8v44.4z"
              data-name="Path 10"
              transform="translate(62.5 164.4)"
            />
            <path
              id="Path_11"
              d="M1488.3 771.2V616.3h96.8v154.9z"
              class="cls-3"
              data-name="Path 11"
        ...
        <path
          id="City_water"
          fill="#8091ff"
          d="M1488.3 692.6v-76.3H1892v76.3z"
          data-name="City water"
          transform="translate(-120.5 217.2)"
        />
        <g id="Windows" transform="translate(8 40)">
          <path
            id="Path_13"
            d="M1488.3 628.5v-12.2h36.6v12.2z"
            class="cls-6"
            data-name="Path 13"
          ...
          <path
            id="Path_25"
            d="M1488.3 628.5v-12.2h83.7v12.2z"
            class="cls-7"
            data-name="Path 25"
          ...
          <path
            id="Path_19"
            fill="#a2b8ff"
            d="M1488.3 665.4v-49h36.6v49z"
            data-name="Path 19"
            transform="translate(-108.2 54.3)"
          />
          <path
            id="Path_15"
            d="M1488.3 651v-34.7h36.6V651z"
            class="cls-11"
            data-name="Path 15"
          ...
          <path
            id="Path_27"
            d="M1488.3 641.2v-24.9h62.9v24.9z"
            class="cls-6"
            data-name="Path 27"
        ...
        <g
          id="Water_Turbulence"
          data-name="Water Turbulence"
          transform="translate(8 40)"
        >
          <g id="Group_4" data-name="Group 4">
            <path
              id="Path_42"
              d="M1386.3 831.3s18.2 3.5 21.8-5.2"
              class="cls-17"
              data-name="Path 42"
            ...
            <path
              id="Path_43"
              d="M1401.3 831.3a23 23 0 0 1-3.7.7c-3.8.3-9.7-.2-11.3-5.9"
              class="cls-17"
              data-name="Path 43"
              transform="translate(32.1 2)"
            />
          </g>
        ...
        <g id="Fence" transform="translate(8 40)">
          ...
          <g id="Ropes">
            <path
              id="Path_45-2"
              d="M1377.5 858c.4-1 14.2 17 25.4 0"
              class="cls-19"
              data-name="Path 45"
      ...
      <svg
        v-if="darkMode"
        class="city__illustration"
        id="City_Illustration1"
        viewBox="0 0 405.6 331.4"
      >
        <defs>
          <linearGradient
            id="linear-gradient"
        ...
        <g
          ...
          data-name="City Illustration"
          transform="translate(-1365.8 -616.6)"
        >
          <path
            id="City_grass"
            fill="#0fd"
...
<style scoped>
  ...
  #City_Illustration0 .cls-1 {
    fill: #a1ffd9;
  }

  #City_Illustration0 .cls-2 {
    fill: #f5f5f5;
  }

  #City_Illustration0 .cls-3 {
    fill: #c4d1fe;
  }

  #City_Illustration0 .cls-6 {
    fill: #bffee6;
  }

  #City_Illustration0 .cls-7 {
    fill: #31feae;
  }

  #City_Illustration0 .cls-11 {
    fill: #7d9cff;
  }

  #City_Illustration0 .cls-14 {
    fill: #5f84fb;
  }

  #City_Illustration0 .cls-17,
  #City_Illustration0 .cls-19 {
    fill: none;
  }
  ...
  #City_Illustration1 .cls-6 {
    fill: #404170;
  }

  #City_Illustration1 .cls-8 {
    fill: #bffee6;
  }

  #City_Illustration1 .cls-9 {
    fill: #31feae;
  }

  #City_Illustration1 .cls-13 {
    fill: #7d9cff;
  }

  #City_Illustration1 .cls-16 {
    fill: #5f84fb;
  }

  #City_Illustration1 .cls-20,
